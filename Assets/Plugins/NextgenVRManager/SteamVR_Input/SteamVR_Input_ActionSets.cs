...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_ngvrmanager p_ngvrmanager;
        ...
        public static SteamVR_Input_ActionSet_ngvrmanager ngvrmanager
        {
            get
            {
                return SteamVR_Actions.p_ngvrmanager.GetCopy<SteamVR_Input_ActionSet_ngvrmanager>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_ngvrmanager = ((SteamVR_Input_ActionSet_ngvrmanager)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_ngvrmanager>("/actions/ngvrmanager")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.ngvrmanager};
        }
    }
}
