...
/// <summary>
/// This allows the ability to automatically load in the start scene instead of the current scene when hitting "play" in the editor
/// 
/// Copied from https://answers.unity.com/questions/441246/editor-script-to-make-play-always-jump-to-a-start.html by YinXiaozhou
/// </summary>
namespace NextGen.Core.DebugTools
{
    public static class PlayFromTheFirstScene
    {
        ...
        static void LoadFirstSceneAtGameBegins()
        {
            ...
            {
                UnityEngine.Debug.LogWarning("The scene build list is empty. Can't play from first scene.");
                return;
            }
