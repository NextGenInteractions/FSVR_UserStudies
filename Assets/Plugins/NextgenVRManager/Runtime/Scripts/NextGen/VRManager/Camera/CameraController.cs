...
public class CameraController : MonoBehaviour
{
    ...
    public void UpdateInput()
    {
        ...
        bool rotate = rotateAlways || (rotateOnLeftButton && UnityEngine.InputSystem.Mouse.current.leftButton.isPressed) || (rotateOnRightButton && UnityEngine.InputSystem.Mouse.current.rightButton.isPressed) || (rotateOnMiddleButton && UnityEngine.InputSystem.Mouse.current.middleButton.isPressed);
        ...
        if (rotate)
        {
            ...
            y = ClampAngle(y - delta.y * rotationSensitivity, yMinLimit, yMaxLimit);
        }
    ...
    private float zoomAdd
    {
        get
        {
            float scrollAxis = UnityEngine.InputSystem.Mouse.current.scroll.y.ReadValue(); 
